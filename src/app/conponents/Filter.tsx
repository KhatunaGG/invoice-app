        ...
        <div>
          <div className=" flex flex-row items-center gap-x-[14px]">
            <div className="text-[15px] leading-[1] tracking-[-0.25px] relative font-bold">
              ...
              <div
                className={`${
                  !statusDropdown ? "hidden" : "visible"
                } transition-all duration-300 absolute top-[30px] left-[-30px] bg-white shadow-lg w-[170px] rounded-[8px] pl-6 py-6 flex flex-col gap-[15px]`}
              >
            ...
            <img
              ...
              style={{
                rotate: statusDropdown === true ? "180deg" : "0deg",
                transition: statusDropdown === true ? ".5s" : "0",
              }}
